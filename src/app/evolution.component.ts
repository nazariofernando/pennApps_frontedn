...
export class EvolutionComponent implements OnInit {
	...
	createGlider(): void {
		...
		this.alphaMorphService.createGlider(name, params, numberGen, "evolution")

		this.af.database.object('/evolution/' + name + '/0', { preserveSnapshot: true })
			.subscribe(snapshot => {
		...
		this.af.database.object('/evolution/' + name + '/bestGlider').set(this.best)

		this.af.database.list('/evolution/' + name, { preserveSnapshot: true })
			.subscribe(snapshots => {
